...
$(function(){
		var mapURL = "${pageContext.request.contextPath}/mainController/getTotalCountByMapUHBase.action";
		var barURL = "${pageContext.request.contextPath}/mainController/getTotalCountByBarUHBase.action";
		var lineURL = "${pageContext.request.contextPath}/mainController/getBSGSInfoUHBase.action";
		//总需求量地图表示
