...
$(function(){
	var mapURL = "${pageContext.request.contextPath}/mainController/getTotalCountByMap.action";
	var barURL = "${pageContext.request.contextPath}/mainController/getTotalCountByBar.action";
	var lineURL = "${pageContext.request.contextPath}/mainController/getBSGSInfo.action";
	//总需求量地图表示
